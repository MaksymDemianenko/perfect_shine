...
const S = {
  ...
  link: { fontFamily: "'Jost', sans-serif", fontSize: 12, fontWeight: 300, color: "rgba(245,240,232,0.5)", textDecoration: "none", display: "block", marginBottom: 10, letterSpacing: "0.05em", transition: "color 0.3s" },
  ...
  waBtn: { display: "inline-block", marginTop: "1rem", padding: "10px 22px", border: "1px solid rgba(201,168,76,0.35)", fontFamily: "'Jost', sans-serif", fontSize: 9, fontWeight: 400, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--ps-gold-light)", textDecoration: "none", transition: "all 0.3s" },
};
      ...
      <div style={S.inner}>
        <div style={S.grid}>
          ...
          <div>
            ...
            <p style={{ ...S.text, marginTop: 12, fontSize: 11 }}>NIP: 6282265846</p>
