      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "120px 1.5rem 80px" }}>
        ...
        <div style={{ backgroundColor: "var(--ps-cream-dark)", border: "1px solid rgba(201,168,76,0.2)", padding: "1.75rem", marginBottom: "1.5rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
            <span style={{ fontFamily: serif, fontSize: 22, color: "var(--ps-dark)", fontWeight: 300 }}>
              {captcha.a} + {captcha.b} = ?
            </span>
          ...
          {captchaError && (
            <p style={{ fontFamily: sans, fontSize: 11, color: "#a33", marginTop: "0.5rem" }}>{captchaError}</p>
          )}
        </div>
          ...
          <div>
            ...
            <div className="name-phone-grid">
              ...
              <div>
                ...
                {phoneError && (
                  <p style={{ fontFamily: sans, fontSize: 10, color: "#a33", marginTop: 4 }}>{phoneError}</p>
                )}
              </div>
            </div>
